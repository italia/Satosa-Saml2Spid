...
if [[ -v SATOSA_BACKEND_MODULES ]]; then
  sed -i "s/BACKEND_MODULES: \[\]/BACKEND_MODULES: \[$SATOSA_BACKEND_MODULES\]/" proxy_conf.yaml
fi

if [[ -v SATOSA_FRONTEND_MODULES ]]; then
  sed -i "s/FRONTEND_MODULES: \[\]/FRONTEND_MODULES: \[$SATOSA_FRONTEND_MODULES\]/" proxy_conf.yaml
fi
